...
cocaine_icon=tk.PhotoImage(file='icons/cocaine.png')
...
color_icons = (light_default_icon ,cocaine_icon,dark_icon,red_icon,monokai_icon,night_blue_icon)
## text  ,background 
#  
color_dict = {
...
def open_file(event=None):
    global url
    url = filedialog.askopenfilename(initialdir= os.getcwd(), title ='Select File',filetypes=[('RKPad File','*.rkp'), ('Text Document','*.txt'),
                                                                        ('Python','*.py'),('C++','*.cpp'),('HTML Docuemnt','*.html'),
                                                                        ('All files','*.*'),('All files','*.*')])
    try:
        ...
        return
    main_application.title(os.path.basename(url) + " - RKpad")
...
def save_file(event=None):
    ...
    try:
        if url :
            ...
            url = filedialog.asksaveasfile(mode = 'w' ,defaultextension = '.txt',filetypes=[('RKPad File','*.rkp'), ('Text Document','*.txt'),
                                                                        ('Python','*.py'),('C++','*.cpp'),('HTML Docuemnt','*.html'),
                                                                        ('All files','*.*'),('All files','*.*')])
...
def exit_func(event=None):
    ...
    try:
        if text_changed:
            mbox = messagebox.askyesnocancel('File not saved!','Do you want to save changes to your file?')
            if mbox is True :
...
##using tag inbuilt function
    ...
    find_dialogue.wm_iconbitmap('RKPad.ico')
